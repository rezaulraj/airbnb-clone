...
const PerksLables = ({ selected, onChange }) => {
  ...
  return (
    <>
      <label
        htmlFor=""
        className="border border-gray-200 p-4 rounded-2xl flex items-center gap-2 cursor-pointer"
      >
      ...
      <label
        ...
        className="border border-gray-200 p-4 rounded-2xl flex items-center gap-2 cursor-pointer"
      >
        <input type="checkbox" checked={selected.includes("Park")} name="Park" onChange={handleCheckBoxClick} />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
